...
---------------------------------------------
To compile the Cairngorm source code as part of your custom application, simply:

   1) add the "com" package to your   '/<project>/src'   directory
   2) add the following arguments to "Project Properties - Flex Compiler - Addtional Arguments"

                -source-path+=locale/{locale} -locale=en_US -allow-source-path-overlap=true"
